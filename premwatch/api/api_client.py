""""API client for interacting with the football data API.

This module provides a class `ApiClient` that encapsulates methods for making
requests to the football data API, including fetching league information.
"""
...
class ApiClient:
    ...
    def get_league_stats(self, season_id, max_time=None) -> dict:
        """Fetches league statistics for a given season. If max_time is provided,
        fetches stats up to that time for the given league.

        Parameters:
            season_id (int): The ID of the season to fetch stats for.
            max_time (int, optional): Unix Timestamp for the upper limit of fetched
                stats. The API will return the stats up to the time specified here. 
                If none is entered, all stats are returned. Defaults to None.
    ...
    def get_schedule(self, season_id, max_time=None) -> dict:
        ...
        Parameters:
            ...
            max_time (int, optional): Unix Timestamp for the upper limit of fetched
                schedule. The API will return the schedule up to the time specified 
                here. If none is entered, all schedule is returned. Defaults to None.

        Returns:
            dict: The JSON response from the API containing the league schedule.
        """
    ...
    def get_league_teams(self, season_id, stats=False, max_time=None) -> dict:
        ...
        Parameters:
            ...
            stats (bool, optional): If True, fetches detailed stats for each team.
                Defaults to False.
            max_time (int, optional): Unix Timestamp for the upper limit of fetched
                stats. The API will return the stats up to the time specified here.
                If none is entered, all stats are returned. Defaults to None.
        ...
        Returns:
            dict: The JSON response from the API containing the teams in the league.
        """
    ...
    def get_league_players(self, season_id, max_time=None) -> dict:
        ...
        Returns:
            dict: The JSON response from the API containing the players in the league.
        """
    ...
    def get_league_referees(self, season_id, max_time=None) -> dict:
        ...
        Returns:
            dict: The JSON response from the API containing the referees in the league.
        """
    ...
    def get_match_details(self, match_id) -> dict:
        ...
        Returns:
            dict: The JSON response from the API containing detailed match data.
        """
        params = {
            "match_id": match_id,
        }
    ...
    def get_league_table(self, season_id, max_time=None) -> dict:
        ...
        Parameters:
            season_id (int): The ID of the league season to fetch the table for.
            max_time (int, optional): Unix Timestamp for the upper limit of fetched
                stats. The API will return the stats up to the time specified here.
                If none is entered, all stats are returned. Defaults to None.
    ...
    def get_player_stats(self, player_id) -> dict:
        """Fetches detailed stats for a given player across all seasons and leagues.

        Parameters:
            player_id (int): The ID of the player to fetch stats for.

        Returns:
            dict: The JSON response from the API containing detailed player stats.
        """
    ...
    def get_referee_stats(self, referee_id) -> dict:
        """Fetches detailed stats for a given referee across all seasons and leagues.

        Parameters:
            referee_id (int): The ID of the referee to fetch stats for.

        Returns:
            dict: The JSON response from the API containing detailed referee stats.
        """
    ...
    def get_over_25_stats(self) -> dict:
        ...
        Returns:
            dict: The JSON response from the API containing Over/Under statistics.
        """
